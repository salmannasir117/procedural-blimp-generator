...
You can use the "RESOLUTION" variables to vary how many polygons there are per curve. For example, if the resolution is 10, there are 10 points per bezier curve, and 100 verticies in the patch. 
